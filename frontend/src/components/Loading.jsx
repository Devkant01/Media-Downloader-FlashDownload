function Loading() {
    return (
        ...
        >
            ...
            <div className="w-4 md:w-5 h-3 mx-2 bg-custom-gradient rounded-md animate-loading-3"></div>
            <div className="w-4 md:w-5 h-3 mx-2 bg-custom-gradient rounded-md animate-loading-4"></div>
        </div>
    );
}
