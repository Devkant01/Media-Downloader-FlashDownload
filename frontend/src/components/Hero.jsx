...
function Hero() {
    ...
    return (
        <main className={`sticky ${isDark ? "bg-white" : "bg-black"} top-[70px] h-screen w-full grid place-content-center bg-no-repeat bg-cover bg-center pb-10 z-20`}>
            ...
            <div
                ...
                } className="indent-4 flex-grow outline-none w-30 bg-transparent md:text-2xl" />
